...
if __name__ == '__main__':
    ...
    generation_model = 'llama2-chat-13B'
    print("generate_consistency_data")
    generate_consistency_data(data_path=orig_data_path, dems_path=dems_path,
                              out_path=f'{exp_dir}/ec_relqa_data.pkl',
                              qn_type='yn', cfgen_format=cfgen_format, cfans_format='obo', model=generation_model)
    print("merge_orig_consistent_data")
